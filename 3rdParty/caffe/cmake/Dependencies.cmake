...
include(${CMAKE_BINARY_DIR}/../3rdParty/caffe/cmake/External/glog.cmake)
include_directories(SYSTEM ${GLOG_INCLUDE_DIRS})
list(APPEND Caffe_LINKER_LIBS ${GLOG_LIBRARIES})

# ---[ Google-gflags
#include("cmake/External/gflags.cmake")
include(${CMAKE_BINARY_DIR}/../3rdParty/caffe/cmake/External/gflags.cmake)
include_directories(SYSTEM ${GFLAGS_INCLUDE_DIRS})
list(APPEND Caffe_LINKER_LIBS ${GFLAGS_LIBRARIES})

# ---[ Google-protobuf
#include(cmake/ProtoBuf.cmake)
include(${CMAKE_BINARY_DIR}/../3rdParty/caffe/cmake/ProtoBuf.cmake)
...
include(${CMAKE_BINARY_DIR}/../3rdParty/caffe/cmake/Cuda.cmake)
if(NOT HAVE_CUDA)
  if(CPU_ONLY)
